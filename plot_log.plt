...
# Now you have log.txt.train and log.txt.test.
...
plot "log.txt.train" using 1:3 title "mnist"

# Training loss vs. training time
# plot "log.txt.train" using 2:3 title "mnist"

# Learning rate vs. training iterations;
# plot "log.txt.train" using 1:4 title "mnist"

# Learning rate vs. training time;
# plot "log.txt.train" using 2:4 title "mnist"
...
# plot "log.txt.test" using 1:4 title "mnist"

# Test accuracy vs. training iterations
# plot "log.txt.test" using 1:3 title "mnist"

# Test loss vs. training time
# plot "log.txt.test" using 2:4 title "mnist"

# Test accuracy vs. training time
# plot "log.txt.test" using 2:3 title "mnist"
